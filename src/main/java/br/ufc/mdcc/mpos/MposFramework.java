...
public final class MposFramework {
    ...
    private String forceCloudletIP = "";
    ...
    public void start(Activity activity, String ip) {
        try {
             forceCloudletIP = ip;
    ...
    private void configureControllers(Activity activity) throws NetworkException, NameNotFoundException {
        ...
        for (Annotation anno : annotations) {
            if (anno instanceof MposConfig) {
                ...
                String endpointSecondary;
                switch (forceCloudletIP) {
                    case "":
                        endpointSecondary = app.endpointSecondary();
                        Log.d("DEBUG_MPOSFRAMEWORK", "ENDPOINTSECONDARY: " + endpointSecondary);
                        break;
                    default:
                        endpointSecondary = forceCloudletIP;
                        Log.d("DEBUG_MPOSFRAMEWORK", "CLOUDLET_FORCE_IP_RESULT: " + endpointSecondary);
                }
                // String endpointSecondary = forceCloudletIP;
